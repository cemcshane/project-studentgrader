...
//	[GPA]/[highest possible GPA] 
	public static void main(String[] args) throws FileNotFoundException { //might need to change to try/catch 
		...
		sc.skip(Pattern.compile("\bReplace the bracketed statements with your class syllabus details.\b\bClass name:\b\bGrade Breakdown: \radd as many categories as needed on separate lines\r\b\b	example: Quizzes, 10%\b"));
